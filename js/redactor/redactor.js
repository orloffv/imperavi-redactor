	...
	Construct.prototype = {
		...
		*/
		showFile: function()
		{
            ...
            redactorActive = this;
			this.modalInit(RLANG.file, this.opts.path + 'plugins/file.html?r', 500, 400, handler);
		},	
        ...
        */  
        ...
        showImage: function()
        {
            ...
            redactorActive = this;
            this.modalInit(RLANG.image, this.opts.path + 'plugins/image.html?r', 570, 450, handler);
